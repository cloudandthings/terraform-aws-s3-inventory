...
def tf_output_basic():
    # tf_output_basic is a reusable test fixture.
...
def test_examples_basic(tf_output_basic):
    # Either simply return / pass here; to test that at least TF apply was successful.
    # pass
    #
    # Or you can continue to test Terraform outputs:
    assert "module_example" in tf_output_basic
    ...
    ...
...
# Multiple uses of the same fixture will reuse the fixture output
